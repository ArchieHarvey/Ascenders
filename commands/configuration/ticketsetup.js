...
module.exports = {
    ...
    botPermissions: ["SEND_MESSAGES", "EMBED_LINKS", "MANAGE_GUILD", "MANAGE_CHANNELS", "ADD_REACTIONS", "USE_EXTERNAL_EMOJIS"],
            ...
            firstCollector.on('collect', async msg => {
                ...
                secondCollector.on('collect', async msg => {
                    ...
                    const thirdEmbed = new MessageEmbed()
                        .setTitle('Ticket System Setup')
                        .setDescription('Which role do you want to have access to see tickets? Please provide a role name, mention, or ID.')
                        .setColor('BLUE');
                    ...
                    thirdCollector.on('collect', async message => {
                        ...
                        const fourthEmbed = new MessageEmbed()
                            .setTitle('Ticket System Setup')
                            .setDescription('The setup is now finished! Please wait for a few minutes for the system to initialize.')
                            .setColor('BLUE');
