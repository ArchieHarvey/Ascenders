...
module.exports = {
    ...
    async execute(client, message, args, data) {
        ...
        let embed = new MessageEmbed()
            ...
            .addField("Links as", `[png](${user.displayAvatarURL({ format: 'png', dynamic: true, size: 1024 })}) | [jpg](${user.displayAvatarURL({ format: 'jpg', dynamic: true, size: 1024 })}) | [webp](${user.displayAvatarURL({ format: 'webp', dynamic: true, size: 1024 })})`)
